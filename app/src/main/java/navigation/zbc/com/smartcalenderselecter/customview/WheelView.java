...
import navigation.zbc.com.smartcalenderselecter.MApplication;
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        int paddingLeftRight = dip2px(8);
        int paddingTopBottom = dip2px(14);
...
//            viewWidth = ((Activity) mContext).getWindowManager().getDefaultDisplay().getWidth();
          /*  WindowManager windowManger = (WindowManager) mContext
            ...
            try {
                ...
                viewWidth=  MApplication.screenWidth;
            }
        }
        if (null == paint) {
            paint = new Paint();
